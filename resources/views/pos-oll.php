...
#header ul.topBarMenu li a.menuOrders .animationWrapper {
    line-height: normal;
    position: relative;
    overflow: hidden;
    padding: 8px;
...
eader ul.topBarMenu li a.menuOrders {
    display: flex;
    align-items: center;
    justify-content: center;
}
#header ul.topBarMenu li a.menuOrders .animationWrapper .orderCount {
    box-sizing: border-box;
    line-height: 16px;
...
<!-- FOR  ADD COUSTOMER IN POS ADD COUSTOMER  -->
<div id="linkOrderScroll" class="linkOrders  linkOrderCustomer" style="display: block; visibility: visible;">
<div class="coustomer_section">

<ul class="list "style="float: none; display: block;">
...
<ul class="list" style="float: none; display: block;">
    ...
    <li class="customer kountaCustomer" customerid="8383824" email="maheshw285@gmail.com" role="button">
        <div class="customerImage" style="background:url()">
          Cu  
        </div>
...
<div class="calci hidden" style="z-index: 11111111;">  <!--  -->
  <div id="calc" class="text-center calc"> 
    ...
    <div id="result" class="reslt"><p id="pospin" class="res">0</p></div>
...
<div class="quantity">
  ...
  <div class="content-body">
    <div class="container">
      <div class="row">
        <div class="col-lg-10" id="product">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="chatbox">
   ...
   <div class="chatboxlink">
     <ul class="ul1">
      <li><p><a href="#">Surcharge</a> </p></li>
      <li><p><a href="#">Discount</a></p></li>
      <li><p><a href="#">Cash Drawer</a></p></li>
      <li><p><a href="#">Email Reciept</a></p></li>
      <li><p><a href="#">Subtotal</a></p></li>
...
<div class="modal fade bd-example-modal-sm  modal-display" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content ">
      ...
      <div class="modal-body"> <input type="text" class="note_box"name="note" placeholder="Note"></div>
...
success:function(data){              
    ...
    var symbole="{{$currency_data->currency_symbol}}";
    $('#productprice-checkout').text( symbole+ "" +data.sum_split_product[0].total);
...
$(document).ready(function(){
$(".menuOrders").on('click','div.menuOrders', function(event){  
$('.tableposmerg').addClass("hidden");
...
/*for when we click on checkoutwindow created_user*/
$(document).ready(function(){
$(".card-checkout").on('click','div.emailrecipet', function(event){ 
