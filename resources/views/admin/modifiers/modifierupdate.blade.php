         ...
         <h4 class="card-title">UPDATE MODIFIER </h4>
            ...
            <div class="card-body">
              <div class="basic-form">
                <form action="{{config('app.baseURL')}}/admin/modifier_update/{{$modifier->modifier_id}}"method="post">
                   @csrf
                    <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                    <label>price </label>
                    <input type="text" class="form-control" name="price" placeholder="please enter  modifier category name" value="{{$modifier->price}}" >
                      @if ($errors->has('price'))
                   ...
                   <input type="text" class="form-control"  name="take_away_price" placeholder="please enter your is_multiple" value="{{$modifier->take_away_price}}">
