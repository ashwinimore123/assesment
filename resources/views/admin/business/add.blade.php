            ...
            <form action="add" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" name="business_name" class="form-control" placeholder="Enter Business" value="{{old('business_name')}}">
                  <span style="color:red;">@error('business_name'){{$message}}@enderror</span>
                </div>
                <div class="form-group col-md-12">
                  <label>Version</label>
                  <input type="number" name="version" class="form-control" placeholder="Enter version" value="{{old('version')}}">
                  <span style="color:red;">@error('version') {{$message}} @enderror</span>
                </div>
                <div class="form-group col-md-12">
                  <label>Package Name</label>
                  <input type="text" name="package_name" class="form-control" placeholder="Enter Package" value="{{old('package_name')}}">
                  <span style="color:red;">@error('package_name') {{$message}} @enderror</span>
                </div>
                <div class="form-group col-md-12">
                  <label>Expiry Date</label>
                  <input type="date" name="expiry_date" class="form-control" placeholder="Enter Expiry Date" value="{{old('expiry_date')}}">
                  <span style="color:red;">@error('expiry_date') {{$message}} @enderror</span>
                </div>
                <div class="form-group col-md-12">
                  <label>Renewal Date</label>
                  <input type="date" name="renewal_date" class="form-control" placeholder="Enter Renewal Date" value="{{old('renewal_date')}}">
                ...
                <div class="form-group col-md-12">
                  <label>Domain</label>
                  <input type="text" name="domain" class="form-control" placeholder="Enter Domain" value="{{old('domain')}}">
                  <span style="color:red;">@error('domain'){{$message}}@enderror</span>
                </div>

                <div class="form-group col-md-12">
                  <label>Sub Domain</label>
                  <input type="text" name="subdomain" class="form-control" placeholder="Enter Sub Domain" value="{{old('subdomain')}}">
                ...
                <div class="form-group col-md-12">                     
                    <div class="custom-control custom-checkbox ml-1">
                        <input type="checkbox" class="custom-control-input" value="1" name="is_restaurant" id="basic_checkbox_2">
                        <label class="custom-control-label" for="basic_checkbox_2">Restaurant</label><br>
