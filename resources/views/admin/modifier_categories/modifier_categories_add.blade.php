   ...
   <div class="col-xl-5 col-lg-12">
     <div class="card" >
       <div class="card-header">
         <h4 class="card-title">ADD NEW MODIFIER CATEGORIES </h4>
          </div>
            <div class="card-body">
              <div class="basic-form">
                <form action="{{url('admin/addmodifier_categories')}}"method="post">
                   @csrf

                   <div class="form-row">
                    <div class="form-group col-md-12">
                    <label>Modifier Category Name</label>
                    <input type="text" class="form-control" name="modifier_category_name" placeholder="please enter  modifier category name" >
                   ...
                   <input type="text" class="form-control"  name="is_multiple" placeholder="please enter your is_multiple" >
