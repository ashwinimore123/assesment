...
$(document).load(function(){
    $('#posdata').on('window.onbeforeunload', function() {
        localStorage.setItem('posdata', $('#posdata').innerHTML);
    });

    var activeTab = localStorage.getItem('posdata');
    {
        $('#posdata').innerHTML=activeTab;
    }
});
</script> -->
...
if (typeof(Storage) !== "undefined") {
      document.getElementById("posdata").innerHTML = localStorage.getItem("posdata");
